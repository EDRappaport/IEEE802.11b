classdef SpectrumAnalyzer < scopeextensions.AbstractSystemObjectScope & dynamicprops
...
properties (Constant, Hidden)
  ...
  LegendSourceSet = matlab.system.StringSet({'Auto','None'});
...
methods
  ...
  function obj = SpectrumAnalyzer(varargin)
    ...
    obj@scopeextensions.AbstractSystemObjectScope();
...
%--------------------------------------------------------------------------  
  ...
  %------------------------------------------------------------------------
  function set.MaxHoldTrace(obj, value)
      warnIncompatibleProperty(obj,'MaxHoldTrace','PlotMaxHoldTrace');
      obj.PlotMaxHoldTrace = value;
  end
  function value = get.MaxHoldTrace(obj)
      warnIncompatibleProperty(obj,'MaxHoldTrace','PlotMaxHoldTrace');
      value = obj.PlotMaxHoldTrace;
  end
  %------------------------------------------------------------------------
  ...
  %------------------------------------------------------------------------
  function set.MinHoldTrace(obj, value)
      warnIncompatibleProperty(obj,'MinHoldTrace','PlotMinHoldTrace');
      obj.PlotMinHoldTrace = value;
  end
  function value = get.MinHoldTrace(obj)
      warnIncompatibleProperty(obj,'MinHoldTrace','PlotMinHoldTrace');
      value = obj.PlotMinHoldTrace;
  end
  %------------------------------------------------------------------------
  ...
  %------------------------------------------------------------------------
  function set.NormalTrace(obj, value)
      warnIncompatibleProperty(obj,'NormalTrace','PlotNormalTrace');
      obj.PlotNormalTrace = value;
  end
  function value = get.NormalTrace(obj)
      warnIncompatibleProperty(obj,'NormalTrace','PlotNormalTrace');
      value = obj.PlotNormalTrace;
  end
  %------------------------------------------------------------------------
  ...
  %------------------------------------------------------------------------
  function set.TwoSidedSpectrum(obj, value)
      warnIncompatibleProperty(obj,'TwoSidedSpectrum','PlotAsTwoSidedSpectrum');
      obj.PlotAsTwoSidedSpectrum = value;
  end
  function value = get.TwoSidedSpectrum(obj)
      warnIncompatibleProperty(obj,'TwoSidedSpectrum','PlotAsTwoSidedSpectrum');
      value = obj.PlotAsTwoSidedSpectrum;
  end
  %------------------------------------------------------------------------
  ...
  function set.Grid(obj, value)
     warnIncompatibleProperty(obj,'Grid','ShowGrid');  
     obj.ShowGrid = value;
  end  
  ...
  %------------------------------------------------------------------------  
  function set.LegendSource(obj, value)    
    warnIncompatibleProperty(obj,'LegendSource','ShowLegend');  
    obj.ShowLegend =  strcmp(value,'Auto');      
  end 
  function value = get.LegendSource(obj)    
    warnIncompatibleProperty(obj,'LegendSource','ShowLegend'); 
    if obj.ShowLegend
      value = 'Auto';
    else
...
methods (Access = protected)
  ...
  function setupImpl(obj, varargin)
    setupImpl@scopeextensions.AbstractSystemObjectScope(obj, varargin{:});
  ...
  function S = saveObjectImpl(obj)
    S = saveObjectImpl@scopeextensions.AbstractSystemObjectScope(obj);    
    S.CurrentLineProperties = getPropValue(obj.pFramework.Visual, 'LineProperties');
  end  
  %------------------------------------------------------------------------  
  function loadObjectImpl(obj, S, wasLocked)
    loadObjectImpl@scopeextensions.AbstractSystemObjectScope(obj, S, wasLocked);    
    if wasLocked
      onSourceRun(obj.pFramework.Visual); 
      if strcmp(obj.SpectrumType,'Spectrogram')
...
%------------------------------------------------------------------------
  ...
  function resetImpl(obj)
    resetImpl@scopeextensions.AbstractSystemObjectScope(obj);
    reset(obj.pFramework.Visual.SpectrumObject);
    flush(obj.pFramework.Visual.DataBuffer);
  end 
   %------------------------------------------------------------------------
  function releaseImpl(obj)
    releaseImpl@scopeextensions.AbstractSystemObjectScope(obj);
