classdef TransferFunctionEstimator < matlab.System
...
%
%   % Example
%   %  Estimate transfer function of system represented by order-64 FIR filter
...
methods(Access = protected)
 ...
 function setupImpl(obj, x , y)
    ...
    setup(obj.pCrossSpectrumEstimator,x,y);
 end
...
methods
  ...
  function w = getFrequencyVector(obj)
   % getFrequencyVector Get the vector of frequencies at which the transfer 
   %   function is estimated, in Hz. 
...
methods(Static, Access=protected)
  function group = getPropertyGroupsImpl
    % Get default parameters group for this System object
     group = matlab.system.display.Section('dsp.TransferFunctionEstimator', ...
                'DependOnPrivatePropertyList', {'SampleRate',...
                 'SpectralAverages','FFTLengthSource','FFTLength',...
