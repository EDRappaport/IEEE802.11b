...
%   Copyright 1995-2013 The MathWorks, Inc.
    ...
    properties
        ...
        %ConvolutionAccumulatorDataType Convolution accumulator word- and 
        %                               fraction-length 
        %   designations Specify the convolution accumulator fixed-point data
        %   type as one of [{'Same as first input'} | 'Custom']. Setting this
        %   property also sets the EnergyAccumulatorDataType property to the same
        %   value.
        ConvolutionAccumulatorDataType;

        %ConvolutionProductDataType Convolution product word- and fraction-length 
        %   designations Specify the convolution product fixed-point data type as
        %   one of [{'Same as first input'} | 'Custom']. Setting this property
        %   also sets the EnergyProductDataType, StepSizeErrorProductDataType,
        %   WeightsUpdateProductDataType and QuotientDataType properties to the
        %   same value.
        ConvolutionProductDataType;

        %CustomConvolutionAccumulatorDataType Convolution accumulator word and 
        %                                     fraction lengths
        ...
        %   value of this property is numerictype([],32,20). The word lengths
        %   of the CustomEnergyAccumulatorDataType and
        %   CustomConvolutionAccumulatorDataType properties must be the same.
        %
        %   See also numerictype.
        CustomConvolutionAccumulatorDataType;

        %CustomConvolutionProductDataType Convolution product word and fraction 
        %                                 lengths
        ...
        %   this property is numerictype([],32,20). The word lengths of the
        %   CustomEnergyProductDataType, CustomConvolutionProductDataType,
        %   CustomStepSizeErrorProductDataType,
        %   CustomWeightsUpdateProductDataType and CustomQuotientDataType
        %   properties must be the same.
        %
        %   See also numerictype.
        CustomConvolutionProductDataType;

        %CustomEnergyAccumulatorDataType Energy accumulator word and fraction 
        %                                lengths
        ...
        %   numerictype([],32,20). The word lengths of the
        %   CustomEnergyProductDataType, CustomConvolutionProductDataType,
        %   CustomStepSizeErrorProductDataType,
        %   CustomWeightsUpdateProductDataType and CustomQuotientDataType
        %   properties must be the same.
        ...
        %   StepSizeSource property is 'Property' and the LeakageFactorDataType
        %   property is 'Custom'. The default value of this property is
        %   numerictype([],16,15). The word lengths of this property and the
        %   CustomStepSizeDataType property must be the same.
        %
        %   See also numerictype.
        ...
        %   default value of this property is numerictype([],16,15). The word
        %   lengths of this property and the CustomLeakageFactorDataType property
        %   must be the same.
        %
        %   See also numerictype.
        CustomStepSizeDataType;

        %CustomStepSizeErrorProductDataType Step size error product word and 
        %                                   fraction lengths
        ...
        %   of this property is numerictype([],32,20). The word lengths of the
        %   CustomEnergyProductDataType, CustomConvolutionProductDataType,
        %   CustomStepSizeErrorProductDataType,
        %   CustomWeightsUpdateProductDataType and CustomQuotientDataType
        %   properties must be the same.
        ...
        %CustomWeightsUpdateProductDataType Weight update product word and  
        %                                   fraction lengths
        ...
        %EnergyAccumulatorDataType Energy accumulator word- and fraction-length 
        %                          designations
        %   Specify the energy accumulator fixed-point data type as one of
        %   [{'Same as first input'} | 'Custom']. This property is applicable
        %   when the Method property is 'Normalized LMS'. Setting this property
        %   also sets the ConvolutionAccumulatorDataType property to the same
        %   value.  
        EnergyAccumulatorDataType;

        %EnergyProductDataType Energy product word- and fraction-length 
        %                      designations
        ...
        %   Method property is 'Normalized LMS'. Setting this property also sets
        %   the ConvolutionProductDataType, StepSizeErrorProductDataType,
        %   WeightsUpdateProductDataType and QuotientDataType properties to the
        %   same value.  
        ...
        %LeakageFactorDataType Leakage factor word- and fraction-length 
        %                      designations
        %   Specify the leakage factor fixed-point data type as one of [{'Same
        %   word length as first input'} | 'Custom']. Setting this property also
        %   sets the StepSizeDataType property to the same value. This property
        %   is applicable when the StepSizeSource property is 'Property'. 
        ...
        %   property is 'Normalized LMS'. Setting this property also sets the
        %   ConvolutionProductDataType, EnergyProductDataType,
        %   StepSizeErrorProductDataType and WeightsUpdateProductDataType
        ...
        %   length as first input'} | 'Custom']. Setting this property also sets
        %   the LeakageFactorDataType property to the same value. This property
        %   is applicable when the StepSizeSource property is 'Property'.
        StepSizeDataType;

        %StepSizeErrorProductDataType Step size error product word- and 
        %                             fraction-length designations
        %   Specify the step size error product fixed-point data type as one of
        %   [{'Same as first input'} | 'Custom']. Setting this property also sets
        %   the ConvolutionProductDataType, EnergyProductDataType,
        %   WeightsUpdateProductDataType and QuotientDataType properties to the
        %   same value.  
        ...
        %WeightsUpdateProductDataType Weight update product word- and 
        %                             fraction-length designations
        %   Specify the weight update product fixed-point data type as one of 
        %   [{'Same as first input'} | 'Custom']. Setting this property also sets
        %   the ConvolutionProductDataType, EnergyProductDataType,
        %   StepSizeErrorProductDataType and QuotientDataType properties to the
        %   same value.    
