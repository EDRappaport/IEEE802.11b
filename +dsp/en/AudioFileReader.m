...
%   Copyright 1995-2013 The MathWorks, Inc.
    ...
    methods
        ...
        function isDoneImpl(in) %#ok<MANU>
            ...
            %   the audio file. If PlayCount property is set to a value greater
            %   than 1, STATUS will be true every time the end is reached. STATUS
            %   is the same as the EOF output value in the step method syntax.
        end
    ...
    properties
        ...
        %   to play the file. The default value of this property is inf.
        PlayCount;
