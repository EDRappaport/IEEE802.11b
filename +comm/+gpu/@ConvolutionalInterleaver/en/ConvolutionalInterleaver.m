...
%ConvolutionalInterleaver Convolutional Interleaver (GPU)
%   H = comm.gpu.ConvolutionalInterleaver creates a convolutional
%   interleaver System object, H. This object permutes the symbols in the
%   input signal using a set of shift registers.
%
%   H = comm.gpu.ConvolutionalInterleaver(Name,Value) creates a
%   convolutional interleaver System object, H, with the specified property
%   Name set to the specified Value. You can specify additional name-value
%   pair arguments in any order as (Name1,Value1,...,NameN,ValueN).
%
%   H = comm.gpu.ConvolutionalInterleaver(M,B,IC) creates a convolutional
%   interleaver System object H, with the NumRegisters property set to M,
%   the RegisterLengthStep property set to B, and the InitialConditions
%   property set to IC. M, B, and IC are value-only arguments. To specify a
...
%   of type double, single, uint32, int32, or logical. Y has the same data
%   type as X.
%
...
%
%   See also comm.ConvolutionalInterleaver,
