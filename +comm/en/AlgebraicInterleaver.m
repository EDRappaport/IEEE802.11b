classdef AlgebraicInterleaver< handle
%AlgebraicInterleaver Permute input symbols using an algebraically derived
%permutation vector 
%   H = comm.AlgebraicInterleaver creates an interleaver System object, H.
%   The object permutes the symbols in the input signal based on an
%   algebraically derived permutation vector.
%
%   H = comm.AlgebraicInterleaver(Name,Value) creates an algebraic
...
%   sequence, Y. The object uses an algebraically derived permutation 
%   vector, based on the algebraic method you specify in the
%   Method property, to form the output. The input X must be a column 
%   vector of length specified by the Length property. X can be numeric,
%   logical, or fixed-point (fi objects). Y has the same data type as X.
%
%   AlgebraicInterleaver methods:
%
%   step     - Interleave input sequence (see above)
%   release  - Allow property value and input characteristics changes
%   clone    - Create algebraic interleaver object with same property
%              values
%   isLocked - Locked status (logical)
%
%   AlgebraicInterleaver properties:
%
%   Method               - Algebraic method to generate permutation vector
%   Length               - Number of elements in input vector
%   MultiplicativeFactor - Cycle vector computation method
...
%
%   See also comm.AlgebraicDeinterleaver, comm.BlockInterleaver.

 
%   Copyright 2009-2013 The MathWorks, Inc.

    methods
        function out=AlgebraicInterleaver
            %AlgebraicInterleaver Permute input symbols using an algebraically derived
            %permutation vector 
            %   H = comm.AlgebraicInterleaver creates an interleaver System object, H.
            %   The object permutes the symbols in the input signal based on an
    ...
    properties
        ...
        %   scalar. If you set the Method property to 'Welch-Costas', then
        %   Length+1 must be a prime number. If you set the Method property to
        ...
        %   'Welch-Costas'. The default value is 'Takeshita-Costello'. 
        ...
        %   calculation uses the equation, mod(k*(n-1)*n/2, N)+1, for any integer
        %   n, between 1 and N. The object creates an intermediate permutation
