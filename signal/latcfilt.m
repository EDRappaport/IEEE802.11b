...
%   subplot(2,1,1);                  
%   plot(f);                            % Max-phase lattice filter ouput
%   title('Max-phase lattice filter ouput')
%   subplot(2,1,2);        
%   plot(g);                            % Min-phase lattice filter ouput
%   title('Min-phase lattice filter ouput')     
%
%   See also FILTER, TF2LATC, LATC2TF.

%   Author(s): D. Orofino, R. Firtion
%   Copyright 1988-2004 The MathWorks, Inc.
%   $Revision: 1.12.4.9 $  $Date: 2012/10/29 19:31:33 $
