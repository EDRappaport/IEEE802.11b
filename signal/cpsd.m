...
%   or complex signals X and Y. In this case, Pxy will have length NFFT and 
%   will be computed over the interval [0,2*Pi) if Fs is not specified and 
%   over the interval [0,Fs) if Fs is specified.  Alternatively, the string
%   'twosided' can be replaced with the string 'onesided' for real signals.
%   This would result in the default behavior.  The string 'twosided' or 
