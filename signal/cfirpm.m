...
%   $Revision: 1.1.6.14 $  $Date: 2011/10/31 06:32:31 $
...
if ~iscell(filt_str)
    if ischar(filt_str) || isa(filt_str, 'function_handle')
        ...
        % User passed a non-string, non-cell, non-functionhandle -- assume it
        % to be a magnitude vector.  Pass this to multiband:
