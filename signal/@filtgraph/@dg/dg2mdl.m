...
%   $Revision: 1.1.6.23 $  $Date: 2011/05/13 18:13:03 $
...
% Therefore create a reference for frequently accessed property.
    ...
    [dspblklibname,fiblklibname,isdspblkloaded,isfiblkloaded]=load_library;
    renderblk
                ...
                case 'delay'
                    ...
                    if strcmpi(get_param(hblk,'BlockType'),'Delay'),
                        ...
                        if M>1 && N>1, 
                            ...
                            IC = ['reshape(',IC,',1,',int2str(M),',',int2str(N),')'];
                        end
...
%--------------------------------------------------------------------------
function [dspblklibname,fiblklibname,isdspblkloaded,isfiblkloaded]=load_library
