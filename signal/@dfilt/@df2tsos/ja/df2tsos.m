%DF2TSOS  直接型 II 転置, 二次型
%
%   Hd = DFILT.DF2TSOS(S) は、<a href="matlab: help zp2sos">zp2sos</a> で
%   定義される SOS 行列に与えられた係数を使って離散時間の 2 次型の直接型 II 
%   転置フィルタオブジェクト Hd を返します。
%
%   Hd = DFILT.DF2TSOS(b1,a1,b2,a2,...) は、b1 と a1 ベクトルに与えられた 
%   1 番目のセクション、b2 と a2ベクトルに与えられた 2 番目のセクション、... に
%   対する係数を使って離散時間の 2 次型の直接型 II 転置フィルタオブジェクト 
%   Hd を返します。
%
%   Hd = DFILT.DF2TSOS(...,g) は、ゲインベクトル g を含みます。g の要素は
