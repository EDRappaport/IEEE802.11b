%LATTICEMAMAX  最大位相に対するラティス移動平均
%
%   Hd = DFILT.LATTICEMAMAX(K) は、ラティス係数 K を持つ最大位相の離散時間
...
%   デモを参照してください。
%
%   係数 k が最大位相フィルタを定義している場合、この構造体の形で得られる
%   フィルタは最大位相フィルタになることに注意してください。係数が最大位相
%   フィルタを定義していない場合は、この構造体の形にしても最大位相フィルタには
%   なりません。
%
