...
%DF1TSOSFILTER   Filter for DFILT.DF1TSOS class in single precision mode

%   Copyright 1988-2012 The MathWorks, Inc.
%   $Revision: 1.1.6.2 $  $Date: 2012/09/20 22:34:55 $
...
[y,zfnum,zfden] = sdf1tsosfilter(num,den,sv,issvnoteq2one,x,zinum,ziden);
