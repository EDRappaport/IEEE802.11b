%DF2  直接型 II
%
%   Hd = DFILT.DF2(NUM, DEN) は、分子係数 NUM と分母係数 DEN を持つ離散時間の
%   直接型 II フィルタオブジェクト Hd を作成します。分母 DEN(1) の最初の係数は、
...
%   参照してください。
%
%   さらに、IIR フィルタの直接型の構造は、数値的な問題を起こす可能性があるこ
%   とに注意してください。多くの場合、伝達関数の作成を避け、<a href="matlab:help dfilt.df2sos">2 次型</a> を使用する
%   ことで、良い結果を得ることができます。
%
%   % 例 #1: 直接インスタンス化
%   [b,a] = butter(4,.5);
