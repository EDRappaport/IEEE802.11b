...
%
%   [...] = TFESTIMATE(...,'twosided') returns the transfer function
%   estimate computed over the whole Nyquist interval for the real signals
%   X and Y. In this case, Txy will have length NFFT and will be computed
...
%   replaced with the string 'onesided' for real signals.  This would
