...
%       $Revision: 1.6.4.5 $
%   $Revision: 1.6.4.5 $  $Date: 2011/05/13 18:07:50 $
...
if bw<=0, error(message('signal:gauspuls:MustBePositiveBW', 'BW')); end
if fc<0, error(message('signal:gauspuls:MustBePositiveFC', 'FC')); end
if bwr>=0, error(message('signal:gauspuls:InvalidRange')); end
