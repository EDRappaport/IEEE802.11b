...
%
%   % Example 2:
%   %   Design a 4-th order Bessel filter.
%
%   Fs =100;                            % Sampling Frequency
%   [num,den] = besself(5,1000);        % Bessel analog filter design
%   [numd,dend]=bilinear(num,den,Fs);   % Analog to Digital mapping
%   fvtool(numd,dend)                   % Visualize the digital filter
%
%   See also BESSELAP, BUTTER, CHEBY1, CHEBY2, FREQZ, FILTER.

%   Author(s): T. Krauss, 3-24-93
%   Copyright 1988-2011 The MathWorks, Inc.
%   $Revision: 1.7.4.5 $  $Date: 2012/10/29 19:30:41 $
