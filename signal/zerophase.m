...
%   frequency vector W (in rad/sample) at which Hr is computed, for the the
%   filter:
%
%               jw               -jw              -jmw
...
%
%   [Hr,W] = ZEROPHASE(SOS) computes the zero-phase of the filter specified
...
%
%   The zero-phase response is evaluated a 512 equally spaced points on the
...
%   $Revision: 1.13.4.14 $  $Date: 2012/12/25 21:35:12 $  
